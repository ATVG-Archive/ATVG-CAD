								...
								<ul class="nav side-menu">
									...
									<li>
										...
										<ul class="nav child_menu">
											<li>
												<a href="https://www.timeanddate.com/stopwatch/" target="_blank">Stopwatch</a>
											</li>
										</ul>
									</li>
									<li>
										<a>
											<i class="fas fa-book"></i> Warnings
											<span class="fas fa-chevron-down"></span>
										</a>
										<ul class="nav child_menu">
											<li>
											...
											<li>
												<a type="button" data-toggle="modal" data-target="#viewWarning"> View Warnings</a>
											</li>
										</ul>
									</li>
									<li>
										<a>
											<i class="fas fa-book"></i> Citations
											<span class="fas fa-chevron-down"></span>
										</a>
										<ul class="nav child_menu">
											<li>
											...
											<li>
												<a type="button" data-toggle="modal" data-target="#viewCitation"> View Citations</a>
											</li>
										</ul>
									</li>
									<li>
										<a>
											<i class="fas fa-book"></i> Arrest Report
											<span class="fas fa-chevron-down"></span>
										</a>
										<ul class="nav child_menu">
											<li>
											...
											<li>
												<a type="button" data-toggle="modal" data-target="#viewArrest"> View Arrests</a>
											</li>
										</ul>
									</li>
									<li>
										<a>
											<i class="fas fa-book"></i> Warrants
											<span class="fas fa-chevron-down"></span>
										</a>
										<ul class="nav child_menu">
											<li>
												<a type="button" data-toggle="modal" data-target="#createWarrant"> Create Warrants</a>
											</li>
											<li>
												<a type="button" data-toggle="modal" data-target="#viewWarrant"> View Warrants</a>
											</li>
										</ul>
									</li>
									<li>
							...
							<ul class="nav navbar-nav navbar-right">
								<li class="">
									...
									<ul class="dropdown-menu dropdown-usermenu pull-right">
										...
										<li>
											<a href="<?php echo BASE_URL; ?>/actions/logout.php?responder=<?php echo $_SESSION['identifier'];?>">
					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								...
								<p>(Not
									<?php echo $name;?>?,
									<a href="<?php echo BASE_URL; ?>/actions/logout.php?responder=<?php echo $_SESSION['identifier'];?>">Log Out</a>)
					...
					<div class="modal-body">
						<form role="form" action="<?php echo BASE_URL; ?>/actions/dispatchActions.php" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-lg-10">
									<textarea name="reason_wanted" class="form-control" style="text-transform:uppercase" rows="5" id="reason_wanted" placeholder="Wanted reason of the BOLOed subject."
									    required> </textarea>
									<span class="fas fa-user form-control-feedback right" aria-hidden="true"></span>
								</div>
								<!-- ./ col-sm-9 -->
			...
			<div class="modal-dialog modal-lg">
								...
								<form role="form" action="<?php echo BASE_URL; ?>/actions/dispatchActions.php" method="post">
									...
									<div class="form-group row">
										...
										<div class="form-group row">
											<label class="col-lg-2 control-label">Vehicle Model</label>
											<div class="col-lg-10">
												<select class="form-control selectpicker vehicle_model" data-live-search="true" name="vehicle_model" title="Vehicle Model"
												    required>
													<?php getVehicleModels();?>
												</select>
											</div>
				...
				<div class="modal fade" id="callDetails" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" id="closecallDetails">
									<span aria-hidden="true">×</span>
								</button>
							...
							<div class="modal-body">
								<form class="newCallForm" id="newCallForm">
									...
									<div class="form-group row">
										<label class="col-lg-2 control-label">Secondary Color</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="Secondary_Color" placeholder="The secondary color, if any, of the BOLO vehicle."
											/> </div>
										<!-- ./ col-sm-9 -->
									</div>
									<!-- ./ form-group -->
						...
						<div class="modal-body">
							<form role="form" action="<?php echo BASE_URL; ?>/actions/dispatchActions.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" name="citation_name_1" id="citation_name_1" size="70" placeholder="Enter a citation"
										    required />
										<input class="form-control" type="number" name="citation_fine_1" id="citation_fine_1" size="10" placeholder="Enter a fine amount"
										    required />
									</div>
									<!-- ./ col-sm-9 -->
								</div>
						...
						<div class="modal-body">
							<form role="form" action="<?php echo BASE_URL; ?>/actions/dispatchActions.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" name="arrest_reason_1" id="arrest_reason_1" size="70" placeholder="Enter a reason for arrest"
										    required />
