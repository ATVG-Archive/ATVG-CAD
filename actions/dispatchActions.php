...
function assignUnit()
{
    ...
    $stmt = $pdo->prepare("UPDATE ".DB_PREFIX."active_users SET status = '0', status_detail = '3' WHERE callsign = ?");
...
function storeCall()
{
    ...
    $stmt = $pdo->prepare("INSERT INTO ".DB_PREFIX."call_history SELECT * FROM ".DB_PREFIX."calls WHERE call_id = ?");
...
function freeUnitStatus($unit)
{
    ...
    $stmt = $pdo->prepare("UPDATE ".DB_PREFIX."active_users SET status = '1', status_detail = '1' WHERE identifier = ?");
...
function cadGetPersonBOLOSid()
{
    ...
    $stmt = $pdo->prepare("SELECT * FROM ".DB_PREFIX."bolos_persons WHERE id = ?");
...
function cadGetVehicleBOLOSid()
{
    ...
    $stmt = $pdo->prepare("SELECT * FROM ".DB_PREFIX."bolos_vehicles WHERE id = ?");
