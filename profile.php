							...
							<ul class="nav navbar-nav navbar-right">
								<li class="">
									...
									<ul class="dropdown-menu dropdown-usermenu pull-right">
										...
										<li><a href="<?php echo BASE_URL; ?>/actions/logout.php"><i class="fas fa-sign-out-alt pull-right"></i> Log
												Out</a></li>
									</ul>
								</li>
											...
											<fieldset>
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<?php if ( DEMO_MODE==true ) {?> readonly
														<?php } ?>>
													</div>
													<!-- ./ col-sm-10 -->
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input name="email" class="form-control" type="email" maxlength="255" value="<?php echo $_SESSION['email'];?>"
														required <?php if ( DEMO_MODE==true ) {?> readonly
														<?php } ?>>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input name="identifier" class="form-control" type="text" maxlength="255" value="<?php echo $_SESSION['identifier'];?>"
														required <?php if ( DEMO_MODE==true ) {?> readonly
														<?php } ?>>
													</div>
													<!-- ./ col-sm-10 -->
					...
					<div class="modal-body">
						<form role="form" action="<?php echo BASE_URL; ?>/actions/profileActions.php" method="post">
							<div class="form-group row">
								...
								<div class="col-lg-10">
									<input class="form-control" type="password" name="password" id="password" size="30" maxlength="255" placeholder="Enter your new password..."
									value="" required <?php if ( DEMO_MODE==true ) {?> readonly
									<?php } ?> />
								</div>
								<!-- ./ col-sm-9 -->
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-10">
									<input class="form-control" type="password" name="confirm_password" size="30" id="confirm_password" maxlength="255"
									placeholder="Retype your new password..." value="" required <?php if ( DEMO_MODE==true ) {?> readonly
									<?php } ?> />
								</div>
								<!-- ./ col-sm-9 -->
							</div>
