										...
										<form action="<?php echo BASE_URL; ?>/actions/profileActions.php" method="post" class="form-horizontal">
											<fieldset>
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input name="name" class="form-control" type="text" maxlength="255" value="<?php echo $name;?>" required <?php if ( DEMO_MODE==true ) {?> readonly
														<?php } ?>>
													</div>
													<!-- ./ col-sm-10 -->
												</div>
												...
												<input name="update_profile_btn" type="submit" class="btn btn-primary btn-lg btn-block" value="Update" <?php if ( DEMO_MODE==true ) {?> disabled
												<?php } ?>/>
											</fieldset>
										</form>
									</div>
