<?php
	...
	if($passed_step == 10){
		...
		$CIV_LIMIT_MAX_IDENTITIES = isset($_SESSION['CIV_LIMIT_MAX_IDENTITIES']) ? prepare_input($_SESSION['CIV_LIMIT_MAX_IDENTITIES']) : 5;
		$CIV_LIMIT_MAX_VEHICLES = isset($_SESSION['CIV_LIMIT_MAX_VEHICLES']) ? prepare_input($_SESSION['CIV_LIMIT_MAX_VEHICLES']) : 5;
		$CIV_LIMIT_MAX_WEAPONS = isset($_SESSION['CIV_LIMIT_MAX_WEAPONS']) ? prepare_input($_SESSION['CIV_LIMIT_MAX_WEAPONS']) : 5;
