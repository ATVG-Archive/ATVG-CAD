<?php
	...
	if($task == 'send'){
		...
		$CIV_WARRANT = isset($_POST['CIV_WARRANT']) ? prepare_input($_POST['CIV_WARRANT']) : '';
		$CIV_REG = isset($_POST['CIV_REG']) ? prepare_input($_POST['CIV_REG']) : '';
		$CIV_LIMIT_MAX_IDENTITIES = isset($_POST['CIV_LIMIT_MAX_IDENTITIES']) ? prepare_input($_POST['CIV_LIMIT_MAX_IDENTITIES']) : 5;
		$CIV_LIMIT_MAX_VEHICLES = isset($_POST['CIV_LIMIT_MAX_VEHICLES']) ? prepare_input($_POST['CIV_LIMIT_MAX_VEHICLES']) : 5;
		$CIV_LIMIT_MAX_WEAPONS = isset($_POST['CIV_LIMIT_MAX_WEAPONS']) ? prepare_input($_POST['CIV_LIMIT_MAX_WEAPONS']) : 5;
	...
	<div id="content">
		...
		<div class="central-part">
			...
			<tr>
				...
				<td><input name="CIV_LIMIT_MAX_IDENTITIES" id="CIV_LIMIT_MAX_IDENTITIES" type="number" value="5" class="form_text" size="28" maxlength="200" onfocus="textboxOnFocus('CIV_LIMIT_MAX_IDENTITIES_notes')" onblur="textboxOnBlur('CIV_LIMIT_MAX_IDENTITIES_notes')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="5" /></td>
			</tr>
			<tr>
				<td>&nbsp;<?php echo lang_key('CIV_LIMIT_MAX_VEHICLES'); ?>&nbsp;</td>
				<td><input name="CIV_LIMIT_MAX_VEHICLES" id="CIV_LIMIT_MAX_VEHICLES" type="number" value="5" class="form_text" size="28" maxlength="200" onfocus="textboxOnFocus('CIV_LIMIT_MAX_VEHICLES_notes')" onblur="textboxOnBlur('CIV_LIMIT_MAX_VEHICLES_notes')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="5" /></td>
			</tr>
			<tr>
				<td>&nbsp;<?php echo lang_key('CIV_LIMIT_MAX_WEAPONS'); ?>&nbsp;</td>
				<td><input name="CIV_LIMIT_MAX_WEAPONS" id="CIV_LIMIT_MAX_WEAPONS" type="number" value="5" class="form_text" size="28" maxlength="200" onfocus="textboxOnFocus('CIV_LIMIT_MAX_WEAPONS_notes')" onblur="textboxOnBlur('CIV_LIMIT_MAX_WEAPONS_notes')" <?php if(EI_MODE != 'debug') echo 'autocomplete="off"'; ?> placeholder="5" /></td>
			</tr>
			<tr><td colspan="2" nowrap height="5px">&nbsp;</td></tr>
			<tr>
				<td colspan="2">
