	...
	<body class="nav-md">
						...
						<div id="lawenforcement" class="dynamic-content main_menu_side hidden-print main_menu">
							<div class="menu_section">
								...
								<ul class="nav side-menu">
									...
									<li>
										<a type="button" data-toggle="modal" data-target="#createWarning">
											<i class="fas fa-exclamation-triangle"></i> Create Warning</a>
									</li>
									<li>
										<a type="button" data-toggle="modal" data-target="#createCitation">
											<i class="fas fa-ticket-alt"></i> Create Citation</a>
									</li>
									<li>
										<a type="button" data-toggle="modal" data-target="#createArrest">
									...
									<div class="x_content">
										<form id="myStatusForm">
											...
											<div class="form-group">
												...
												<div class="col-md-10 col-sm-10 col-xs-10">
													<select name="statusSelect" class="form-control selectpicker <?php echo $_SESSION['identifier'];?>" id="statusSelect" onChange="responderChangeStatus(this);"
      ...
      ?>
								...
								<div id="ncic" class="row">
									...
									<?php }
									if ( FIRE_NCIC_PLATE xor EMS_NCIC_PLATE xor ROADSIDE_NCIC_PLATE ) { ?>
									<div id="ncic" class="row">
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div class="x_panel">
												<div class="x_title">
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" id="closeCallsign" data-dismiss="modal">
			   	...
			   	?>
					...
					<script type="text/javascript">
						...
						$(document).ready(function () {
							...
							if (dynamicContent == 'police' || dynamicContent == 'highway' || dynamicContent == 'state' ||
