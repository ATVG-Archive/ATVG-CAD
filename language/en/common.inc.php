...
$arrLang['CIV_LIMIT_MAX_IDENTITIES']       = "Maximum amount of Identities";
$arrLang['CIV_LIMIT_MAX_IDENTITIES_notes'] = "This is the maximum amount of identities one civilian can create. Default is '5'. Set to '0' for unlimited";
$arrLang['CIV_LIMIT_MAX_VEHICLES']         = "Maximum amount of Vehicles";
$arrLang['CIV_LIMIT_MAX_VEHICLES_notes']   = "This is the maximum amount of vehicles one civilian can create. Default is '5'. Set to '0' for unlimited";
$arrLang['CIV_LIMIT_MAX_WEAPONS']          = "Maximum amount of Weapons";
$arrLang['CIV_LIMIT_MAX_WEAPONS_notes']    = "This is the maximum amount of weapons one civilian can create. Default is '5'. Set to '0' for unlimited";
