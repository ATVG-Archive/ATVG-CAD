                    ...
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="javascript:void(0)" class="site_title">
                                ...
                                <span>
                                    <?php echo COMMUNITY_NAME;?> User</span>
                            </a>
                        </div>
                                        ...
                                        <form id="resetPassword" action="<?php echo BASE_URL; ?>/reset-password.php" method="post" class="form-horizontal">
                                            <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="password" id="password" class="form-control" type="password" maxlength="255" placeholder="Enter your new password..."
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="confirm_password" id="confirm_password" class="form-control" type="password" maxlength="255" placeholder="Retype your new password..."
                                                            value="" required <?php if ( DEMO_MODE==true ) {?> readonly
                                                        <?php } ?>>
                                                    </div>
                                                    <!-- ./ col-sm-10 -->
                                                ...
                                                <br />
                                                <!-- ./ form-group -->
                                                <input type="submit" name="resetpass" id="resetpass" class="btn btn-primary btn-lg btn-block" value="Change Password" <?php
                                                    if ( DEMO_MODE==true ) {?> disabled
                                                <?php } ?>/>
                                                <p> Note: If you click this button and nothing shows up, hit refresh, then resend,
                                                    then logout. </p>
                                            </fieldset>
                                        </form>
                                    </div>
