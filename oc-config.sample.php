 ...
 * If CIV_LIMIT_MAX_IDENTITIES is '0' then civilian will be able to create unlimited identites.
 * Otherwise, if CIV_LIMIT_MAX_IDENTITIES is a value other than '0' then it will cap the maximum
